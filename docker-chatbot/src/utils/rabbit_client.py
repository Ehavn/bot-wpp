...
def get_rabbit_connection():
    """
    Carrega a configuração do RabbitMQ a partir das variáveis de ambiente
    e estabelece uma conexão autenticada.
    """
    rabbit_config = {
...
def setup_queues(channel, config):
    ...
    channel.queue_bind(queue=dlq_name, exchange=dlx_name, routing_key=main_queue)
